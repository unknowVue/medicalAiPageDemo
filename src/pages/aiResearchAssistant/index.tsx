  ...
  return (
    <>
      <div className={scssStyle.container}>
        <Card style={{ height: '100vh', width: '350px', borderLeft: 'none' }} shadow='xs' padding="lg" withBorder>
          ...
          <Select
            ...
            optionRender={(option) => (
              <Group flex="1" gap="xs">
                <div style={{ borderRadius: '15px', padding: '0px 12px',paddingBottom: '3px', border: '1px solid #e0e0e0ff' }}>
                  {option.data.type}
                </div>
                {option.label}
              </Group>
